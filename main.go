...
func main() {
    ...
    ingressClassInformer, ingressInformer, serviceInformer, endpointInformer, podInformer, nodeInformer := setupInformers(informerFactory, ctx, classParamInformer)
...
func setupInformers(informerFactory informers.SharedInformerFactory, ctx context.Context, classParamInformer ctrcache.Informer) (networkinginformers.IngressClassInformer, networkinginformers.IngressInformer, v1.ServiceInformer, v1.EndpointsInformer, v1.PodInformer, v1.NodeInformer) {
    ...
    return ingressClassInformer, ingressInformer, serviceInformer, endpointInformer, podInformer, nodeInformer
}
