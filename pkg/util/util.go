...
const (
	IngressClassLoadBalancerIdAnnotation = "lb.ingress.oraclecloud.com/id"
	...
	IngressListenerTlsCertificateAnnotation = "lb.ingress.oraclecloud.com/certificate-ocid"

	// IngressProtocolAnntoation - HTTP only for now
	// HTTP, HTTP2 - accepted.
	IngressProtocolAnnotation = "lb.ingress.oraclecloud.com/protocol"

	IngressPolicyAnnotation = "lb.ingress.oraclecloud.com/policy"

	IngressHealthCheckProtocolAnnotation             = "lb.ingress.oraclecloud.com/healthcheck-protocol"
	IngressHealthCheckPortAnnotation                 = "lb.ingress.oraclecloud.com/healthcheck-port"
	IngressHealthCheckPathAnnotation                 = "lb.ingress.oraclecloud.com/healthcheck-path"
	IngressHealthCheckIntervalMillisecondsAnnotation = "lb.ingress.oraclecloud.com/healthcheck-interval-milliseconds"
	IngressHealthCheckTimeoutMillisecondsAnnotation  = "lb.ingress.oraclecloud.com/healthcheck-timeout-milliseconds"
	IngressHealthCheckRetriesAnnotation              = "lb.ingress.oraclecloud.com/healthcheck-retries"
	IngressHealthCheckReturnCodeAnnotation           = "lb.ingress.oraclecloud.com/healthcheck-return-code"
	IngressHealthCheckResponseBodyRegexAnnotation    = "lb.ingress.oraclecloud.com/healthcheck-response-regex"
	IngressHealthCheckForcePlainTextAnnotation       = "lb.ingress.oraclecloud.com/healthcheck-force-plaintext"
